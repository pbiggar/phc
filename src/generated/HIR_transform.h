...
public:
    ...
    virtual void pre_assign_var(HIR_assign_var* in, List<HIR_statement*>* out);
    virtual void pre_assign_array(HIR_assign_array* in, List<HIR_statement*>* out);
    virtual void pre_assign_var_var(HIR_assign_var_var* in, List<HIR_statement*>* out);
    virtual void pre_push_array(HIR_push_array* in, List<HIR_statement*>* out);
    virtual HIR_expr* pre_index_array(HIR_index_array* in);
    virtual HIR_variable_name* pre_variable_variable(HIR_variable_variable* in);
    ...
    virtual HIR_constant* pre_constant(HIR_constant* in);
...
public:
    ...
    virtual void post_assign_var(HIR_assign_var* in, List<HIR_statement*>* out);
    virtual void post_assign_array(HIR_assign_array* in, List<HIR_statement*>* out);
    virtual void post_assign_var_var(HIR_assign_var_var* in, List<HIR_statement*>* out);
    virtual void post_push_array(HIR_push_array* in, List<HIR_statement*>* out);
    virtual HIR_expr* post_index_array(HIR_index_array* in);
    virtual HIR_variable_name* post_variable_variable(HIR_variable_variable* in);
    ...
    virtual HIR_constant* post_constant(HIR_constant* in);
...
public:
    ...
    virtual HIR_static_value* transform_static_value(HIR_static_value* in);
    ...
    virtual List<HIR_static_array_elem*>* transform_static_array_elem_list(List<HIR_static_array_elem*>* in);
    virtual List<HIR_static_array_elem*>* transform_static_array_elem(HIR_static_array_elem* in);
    virtual HIR_static_array_key* transform_static_array_key(HIR_static_array_key* in);
...
public:
    ...
    virtual HIR_static_value* pre_static_value(HIR_static_value* in);
    ...
    virtual HIR_static_array_key* pre_static_array_key(HIR_static_array_key* in);
...
public:
    ...
    virtual HIR_static_value* post_static_value(HIR_static_value* in);
    ...
    virtual HIR_static_array_key* post_static_array_key(HIR_static_array_key* in);
