...
{
    visit_optional (in->init == NULL);
	visit_expr(in->init);
    visit_optional (in->cond == NULL);
	visit_expr(in->cond);
    visit_optional (in->incr == NULL);
	visit_expr(in->incr);
    visit_statement_list(in->statements);
}
...
void Visitor::visit_statement_list(List<Statement*>* in)
{
    ...
    {
    	pre_list("AST", "Statement", in->size(), false);
    	...
    	post_list("AST", "Statement", in->size(), false);
    }
}

void Visitor::visit_statement(Statement* in)
{
    visit_type("AST", "Statement");
    if(in == NULL)
...
void Visitor::visit_interface_name_list(List<INTERFACE_NAME*>* in)
{
    ...
    {
    	pre_list("AST", "INTERFACE_NAME", in->size(), false);
    	...
    	post_list("AST", "INTERFACE_NAME", in->size(), false);
    }
}
...
void Visitor::visit_member_list(List<Member*>* in)
{
    ...
    {
    	pre_list("AST", "Member", in->size(), false);
    	...
    	post_list("AST", "Member", in->size(), false);
    }
}

void Visitor::visit_member(Member* in)
{
    visit_type("AST", "Member");
    if(in == NULL)
...
void Visitor::visit_formal_parameter_list(List<Formal_parameter*>* in)
{
    ...
    {
    	pre_list("AST", "Formal_parameter", in->size(), false);
    	...
    	post_list("AST", "Formal_parameter", in->size(), false);
    }
}

void Visitor::visit_formal_parameter(Formal_parameter* in)
{
    visit_type("AST", "Formal_parameter");
    if(in == NULL)
...
{
    visit_type("AST", "Name_with_default");
    if(in == NULL)
...
void Visitor::visit_name_with_default_list(List<Name_with_default*>* in)
{
    ...
    {
    	pre_list("AST", "Name_with_default", in->size(), false);
    	...
    	post_list("AST", "Name_with_default", in->size(), false);
    }
}

void Visitor::visit_variable_name(VARIABLE_NAME* in)
{
    visit_type("AST", "VARIABLE_NAME");
    if(in == NULL)
...
void Visitor::visit_switch_case_list(List<Switch_case*>* in)
{
    ...
    {
    	pre_list("AST", "Switch_case", in->size(), false);
    	...
    	post_list("AST", "Switch_case", in->size(), false);
    }
}

void Visitor::visit_switch_case(Switch_case* in)
{
    visit_type("AST", "Switch_case");
    if(in == NULL)
...
void Visitor::visit_variable_name_list(List<Variable_name*>* in)
{
    ...
    {
    	pre_list("AST", "Variable_name", in->size(), false);
    	...
    	post_list("AST", "Variable_name", in->size(), false);
    }
}
...
void Visitor::visit_directive_list(List<Directive*>* in)
{
    ...
    {
    	pre_list("AST", "Directive", in->size(), false);
    	...
    	post_list("AST", "Directive", in->size(), false);
    }
}

void Visitor::visit_directive(Directive* in)
{
    visit_type("AST", "Directive");
    if(in == NULL)
...
void Visitor::visit_catch_list(List<Catch*>* in)
{
    ...
    {
    	pre_list("AST", "Catch", in->size(), false);
    	...
    	post_list("AST", "Catch", in->size(), false);
    }
}

void Visitor::visit_catch(Catch* in)
{
    visit_type("AST", "Catch");
    if(in == NULL)
...
{
    visit_type("AST", "LABEL_NAME");
    if(in == NULL)
    	visit_null("AST", "LABEL_NAME");
    else
    {
...
{
    visit_type("AST", "HT_ITERATOR");
    if(in == NULL)
    	visit_null("AST", "HT_ITERATOR");
    else
    {
...
void Visitor::visit_list_element_list(List<List_element*>* in)
{
    ...
    {
    	pre_list("AST", "List_element", in->size(), true);
    	...
    	post_list("AST", "List_element", in->size(), true);
    }
}

void Visitor::visit_list_element(List_element* in)
{
    visit_type("AST", "List_element");
    if(in == NULL)
...
void Visitor::visit_expr_list(List<Expr*>* in)
{
    ...
    {
    	pre_list("AST", "Expr", in->size(), true);
    	...
    	post_list("AST", "Expr", in->size(), true);
    }
}
...
void Visitor::visit_array_elem_list(List<Array_elem*>* in)
{
    ...
    {
    	pre_list("AST", "Array_elem", in->size(), false);
    	...
    	post_list("AST", "Array_elem", in->size(), false);
    }
}

void Visitor::visit_array_elem(Array_elem* in)
{
    visit_type("AST", "Array_elem");
    if(in == NULL)
...
void Visitor::visit_actual_parameter_list(List<Actual_parameter*>* in)
{
    ...
    {
    	pre_list("AST", "Actual_parameter", in->size(), false);
    	...
    	post_list("AST", "Actual_parameter", in->size(), false);
    }
}

void Visitor::visit_actual_parameter(Actual_parameter* in)
{
    visit_type("AST", "Actual_parameter");
    if(in == NULL)
