...
type php_t_directive_name ::= c_php_t_directive_name { null } .
...
type php_t_cast ::= c_php_t_cast { string } .
...
type php_while ::= c_php_while {php_expr, list[php_statement]}.
type php_do ::= c_php_do {list[php_statement], php_expr}.
type php_for ::= c_php_for {php_expr, php_expr, php_expr, list[php_statement]}.
...
type php_declare ::= c_php_declare {list[php_directive], list[php_statement]}.
type php_directive ::= c_php_directive {php_t_directive_name, php_expr}.
...
type php_post_op ::= c_php_post_op {php_variable, php_t_op}.
...
% Disjunctive types
type php_source_rep ::= 
		  c_php_source_rep_php_t_interface_name { php_t_interface_name } 
		| c_php_source_rep_php_t_class_name { php_t_class_name } 
		| c_php_source_rep_php_t_method_name { php_t_method_name } 
		| c_php_source_rep_php_t_variable_name { php_t_variable_name } 
		| c_php_source_rep_php_t_cast { php_t_cast } 
		| c_php_source_rep_php_t_op { php_t_op } 
		| c_php_source_rep_php_t_constant_name { php_t_constant_name } 
		| c_php_source_rep_php_t_label_name { php_t_label_name } 
		| c_php_source_rep_php_t_directive_name { php_t_directive_name } 
		| c_php_source_rep_php_t_int { php_t_int } 
		| c_php_source_rep_php_t_real { php_t_real } 
		| c_php_source_rep_php_t_string { php_t_string } 
		| c_php_source_rep_php_t_bool { php_t_bool } 
		| c_php_source_rep_php_t_nil { php_t_nil } 
		.
type php_identifier ::= 
		...
		| c_php_identifier_php_t_directive_name { php_t_directive_name } 
		.
type php_commented_node ::= 
		...
		| c_php_commented_node_php_while { php_while } 
		| c_php_commented_node_php_do { php_do } 
		| c_php_commented_node_php_for { php_for } 
		...
		| c_php_commented_node_php_declare { php_declare } 
		| c_php_commented_node_php_nop { php_nop } 
...
type php_target ::= 
		...
		| c_php_target_php_post_op { php_post_op } 
		| c_php_target_php_array { php_array } 
		| c_php_target_php_conditional_expr { php_conditional_expr } 
...
type php_expr ::= 
		...
		| c_php_expr_php_post_op { php_post_op } 
		| c_php_expr_php_array { php_array } 
		| c_php_expr_php_conditional_expr { php_conditional_expr } 
...
type php_statement ::= 
		...
		| c_php_statement_php_while { php_while } 
		| c_php_statement_php_do { php_do } 
		| c_php_statement_php_for { php_for } 
		...
		| c_php_statement_php_declare { php_declare } 
		| c_php_statement_php_nop { php_nop } 
...
type php_node ::= 
		...
		| c_php_node_php_directive { php_directive } 
		...
		| c_php_node_php_post_op { php_post_op } 
		...
		| c_php_node_php_while { php_while } 
		| c_php_node_php_do { php_do } 
		| c_php_node_php_for { php_for } 
		...
		| c_php_node_php_declare { php_declare } 
		| c_php_node_php_nop { php_nop } 
		...
		| c_php_node_php_t_directive_name { php_t_directive_name } 
...
predicate phc_while (EXPR:php_expr, STATEMENTS:list[php_statement]).
predicate phc_do (STATEMENTS:list[php_statement], EXPR:php_expr).
predicate phc_for (INIT:php_expr, COND:php_expr, INCR:php_expr, STATEMENTS:list[php_statement]).
...
predicate phc_declare (DIRECTIVES:list[php_directive], STATEMENTS:list[php_statement]).
predicate phc_directive (DIRECTIVE_NAME:php_t_directive_name, EXPR:php_expr).
...
predicate phc_post_op (VARIABLE:php_variable, OP:php_t_op).
