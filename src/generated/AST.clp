...
type t_ast_List_assignment.
type t_ast_Nested_list_elements.
type t_ast_Cast.
type t_ast_Unary_op.
type t_ast_Bin_op.
type t_ast_Conditional_expr.
type t_ast_Ignore_errors.
type t_ast_Constant.
...
type t_ast_DIRECTIVE_NAME ::= t_ast_DIRECTIVE_NAME_id {id}.
...
type t_ast_While ::= t_ast_While_id {id}.
type t_ast_Do ::= t_ast_Do_id {id}.
type t_ast_For ::= t_ast_For_id {id}.
type t_ast_Foreach ::= t_ast_Foreach_id {id}.
type t_ast_Switch ::= t_ast_Switch_id {id}.
type t_ast_Switch_case ::= t_ast_Switch_case_id {id}.
...
type t_ast_Declare ::= t_ast_Declare_id {id}.
type t_ast_Directive ::= t_ast_Directive_id {id}.
...
type t_ast_Nop ::= t_ast_Nop_id {id}.
...
type t_ast_List_assignment ::= t_ast_List_assignment_id {id}.
type t_ast_Nested_list_elements ::= t_ast_Nested_list_elements_id {id}.
type t_ast_Cast ::= t_ast_Cast_id {id}.
type t_ast_Unary_op ::= t_ast_Unary_op_id {id}.
type t_ast_Bin_op ::= t_ast_Bin_op_id {id}.
type t_ast_Conditional_expr ::= t_ast_Conditional_expr_id {id}.
type t_ast_Ignore_errors ::= t_ast_Ignore_errors_id {id}.
...
type t_ast_Post_op ::= t_ast_Post_op_id {id}.
...
% Disjunctive types
type t_ast_Source_rep ::= 
		  t_ast_Source_rep_t_ast_INTERFACE_NAME_id { t_ast_INTERFACE_NAME } 
		| t_ast_Source_rep_t_ast_CLASS_NAME_id { t_ast_CLASS_NAME } 
		| t_ast_Source_rep_t_ast_METHOD_NAME_id { t_ast_METHOD_NAME } 
		| t_ast_Source_rep_t_ast_VARIABLE_NAME_id { t_ast_VARIABLE_NAME } 
		| t_ast_Source_rep_t_ast_CAST_id { t_ast_CAST } 
		| t_ast_Source_rep_t_ast_OP_id { t_ast_OP } 
		| t_ast_Source_rep_t_ast_CONSTANT_NAME_id { t_ast_CONSTANT_NAME } 
		| t_ast_Source_rep_t_ast_LABEL_NAME_id { t_ast_LABEL_NAME } 
		| t_ast_Source_rep_t_ast_DIRECTIVE_NAME_id { t_ast_DIRECTIVE_NAME } 
		| t_ast_Source_rep_t_ast_INT_id { t_ast_INT } 
		| t_ast_Source_rep_t_ast_REAL_id { t_ast_REAL } 
		| t_ast_Source_rep_t_ast_STRING_id { t_ast_STRING } 
		| t_ast_Source_rep_t_ast_BOOL_id { t_ast_BOOL } 
		| t_ast_Source_rep_t_ast_NIL_id { t_ast_NIL } 
		.
type t_ast_Identifier ::= 
		...
		| t_ast_Identifier_t_ast_DIRECTIVE_NAME_id { t_ast_DIRECTIVE_NAME } 
		.
type t_ast_Commented_node ::= 
		  t_ast_Commented_node_t_ast_Method_id { t_ast_Method } 
		| t_ast_Commented_node_t_ast_Attribute_id { t_ast_Attribute } 
		| t_ast_Commented_node_t_ast_Class_def_id { t_ast_Class_def } 
		| t_ast_Commented_node_t_ast_Interface_def_id { t_ast_Interface_def } 
		| t_ast_Commented_node_t_ast_Return_id { t_ast_Return } 
		| t_ast_Commented_node_t_ast_Static_declaration_id { t_ast_Static_declaration } 
		| t_ast_Commented_node_t_ast_Global_id { t_ast_Global } 
		| t_ast_Commented_node_t_ast_Try_id { t_ast_Try } 
		| t_ast_Commented_node_t_ast_Throw_id { t_ast_Throw } 
		| t_ast_Commented_node_t_ast_Eval_expr_id { t_ast_Eval_expr } 
		| t_ast_Commented_node_t_ast_If_id { t_ast_If } 
		| t_ast_Commented_node_t_ast_While_id { t_ast_While } 
		| t_ast_Commented_node_t_ast_Do_id { t_ast_Do } 
		| t_ast_Commented_node_t_ast_For_id { t_ast_For } 
		| t_ast_Commented_node_t_ast_Foreach_id { t_ast_Foreach } 
		| t_ast_Commented_node_t_ast_Switch_id { t_ast_Switch } 
		| t_ast_Commented_node_t_ast_Break_id { t_ast_Break } 
		| t_ast_Commented_node_t_ast_Continue_id { t_ast_Continue } 
		| t_ast_Commented_node_t_ast_Declare_id { t_ast_Declare } 
		| t_ast_Commented_node_t_ast_Nop_id { t_ast_Nop } 
		| t_ast_Commented_node_t_ast_Label_id { t_ast_Label } 
		| t_ast_Commented_node_t_ast_Goto_id { t_ast_Goto } 
		| t_ast_Commented_node_t_ast_Branch_id { t_ast_Branch } 
		| t_ast_Commented_node_t_ast_Foreach_next_id { t_ast_Foreach_next } 
		| t_ast_Commented_node_t_ast_Foreach_reset_id { t_ast_Foreach_reset } 
		| t_ast_Commented_node_t_ast_Foreach_end_id { t_ast_Foreach_end } 
		| t_ast_Commented_node_t_ast_Switch_case_id { t_ast_Switch_case } 
		| t_ast_Commented_node_t_ast_Catch_id { t_ast_Catch } 
		.
type t_ast_Class_name ::= 
...
type t_ast_Target ::= 
		...
		| t_ast_Target_t_ast_List_assignment_id { t_ast_List_assignment } 
		| t_ast_Target_t_ast_Post_op_id { t_ast_Post_op } 
		| t_ast_Target_t_ast_Array_id { t_ast_Array } 
		| t_ast_Target_t_ast_Conditional_expr_id { t_ast_Conditional_expr } 
		| t_ast_Target_t_ast_Ignore_errors_id { t_ast_Ignore_errors } 
...
type t_ast_Variable_name ::= 
		...
		.
type t_ast_List_element ::= 
		  t_ast_List_element_t_ast_Variable_id { t_ast_Variable } 
		| t_ast_List_element_t_ast_Nested_list_elements_id { t_ast_Nested_list_elements } 
		.
type t_ast_Literal ::= 
...
type t_ast_Expr ::= 
		...
		| t_ast_Expr_t_ast_List_assignment_id { t_ast_List_assignment } 
		| t_ast_Expr_t_ast_Post_op_id { t_ast_Post_op } 
		| t_ast_Expr_t_ast_Array_id { t_ast_Array } 
		| t_ast_Expr_t_ast_Conditional_expr_id { t_ast_Conditional_expr } 
		| t_ast_Expr_t_ast_Ignore_errors_id { t_ast_Ignore_errors } 
...
type t_ast_Statement ::= 
		...
		| t_ast_Statement_t_ast_While_id { t_ast_While } 
		| t_ast_Statement_t_ast_Do_id { t_ast_Do } 
		| t_ast_Statement_t_ast_For_id { t_ast_For } 
		| t_ast_Statement_t_ast_Foreach_id { t_ast_Foreach } 
		| t_ast_Statement_t_ast_Switch_id { t_ast_Switch } 
		| t_ast_Statement_t_ast_Break_id { t_ast_Break } 
		| t_ast_Statement_t_ast_Continue_id { t_ast_Continue } 
		| t_ast_Statement_t_ast_Declare_id { t_ast_Declare } 
		| t_ast_Statement_t_ast_Nop_id { t_ast_Nop } 
...
type t_ast_Node ::= 
		...
		| t_ast_Node_t_ast_Directive_id { t_ast_Directive } 
		| t_ast_Node_t_ast_Variable_id { t_ast_Variable } 
		| t_ast_Node_t_ast_Nested_list_elements_id { t_ast_Nested_list_elements } 
		...
		| t_ast_Node_t_ast_List_assignment_id { t_ast_List_assignment } 
		| t_ast_Node_t_ast_Post_op_id { t_ast_Post_op } 
		| t_ast_Node_t_ast_Array_id { t_ast_Array } 
		| t_ast_Node_t_ast_Conditional_expr_id { t_ast_Conditional_expr } 
		| t_ast_Node_t_ast_Ignore_errors_id { t_ast_Ignore_errors } 
		...
		| t_ast_Node_t_ast_While_id { t_ast_While } 
		| t_ast_Node_t_ast_Do_id { t_ast_Do } 
		| t_ast_Node_t_ast_For_id { t_ast_For } 
		| t_ast_Node_t_ast_Foreach_id { t_ast_Foreach } 
		| t_ast_Node_t_ast_Switch_id { t_ast_Switch } 
		| t_ast_Node_t_ast_Break_id { t_ast_Break } 
		| t_ast_Node_t_ast_Continue_id { t_ast_Continue } 
		| t_ast_Node_t_ast_Declare_id { t_ast_Declare } 
		| t_ast_Node_t_ast_Nop_id { t_ast_Nop } 
		...
		| t_ast_Node_t_ast_Switch_case_id { t_ast_Switch_case } 
		...
		| t_ast_Node_t_ast_DIRECTIVE_NAME_id { t_ast_DIRECTIVE_NAME } 
...
predicate ast_Attribute (ID:t_ast_Attribute, ATTR_MOD:t_ast_Attr_mod, VARS:list[t_ast_Name_with_default]).
...
predicate ast_If (ID:t_ast_If, EXPR:t_ast_Expr, IFTRUE:list[t_ast_Statement], IFFALSE:list[t_ast_Statement]).
predicate ast_While (ID:t_ast_While, EXPR:t_ast_Expr, STATEMENTS:list[t_ast_Statement]).
predicate ast_Do (ID:t_ast_Do, STATEMENTS:list[t_ast_Statement], EXPR:t_ast_Expr).
predicate ast_For (ID:t_ast_For, INIT:maybe[t_ast_Expr], COND:maybe[t_ast_Expr], INCR:maybe[t_ast_Expr], STATEMENTS:list[t_ast_Statement]).
predicate ast_Foreach (ID:t_ast_Foreach, EXPR:t_ast_Expr, KEY:maybe[t_ast_Variable], IS_REF:bool, VAL:t_ast_Variable, STATEMENTS:list[t_ast_Statement]).
predicate ast_Switch (ID:t_ast_Switch, EXPR:t_ast_Expr, SWITCH_CASES:list[t_ast_Switch_case]).
predicate ast_Switch_case (ID:t_ast_Switch_case, EXPR:maybe[t_ast_Expr], STATEMENTS:list[t_ast_Statement]).
...
predicate ast_Static_declaration (ID:t_ast_Static_declaration, VARS:list[t_ast_Name_with_default]).
predicate ast_Global (ID:t_ast_Global, VARIABLE_NAMES:list[t_ast_Variable_name]).
predicate ast_Declare (ID:t_ast_Declare, DIRECTIVES:list[t_ast_Directive], STATEMENTS:list[t_ast_Statement]).
predicate ast_Directive (ID:t_ast_Directive, DIRECTIVE_NAME:t_ast_DIRECTIVE_NAME, EXPR:t_ast_Expr).
...
predicate ast_Nop (ID:t_ast_Nop).
predicate ast_Branch (ID:t_ast_Branch, EXPR:t_ast_Expr, IFTRUE:t_ast_LABEL_NAME, IFFALSE:t_ast_LABEL_NAME).
...
predicate ast_List_assignment (ID:t_ast_List_assignment, LIST_ELEMENTS:list[maybe[t_ast_List_element]], EXPR:t_ast_Expr).
predicate ast_Nested_list_elements (ID:t_ast_Nested_list_elements, LIST_ELEMENTS:list[maybe[t_ast_List_element]]).
predicate ast_Cast (ID:t_ast_Cast, CAST:t_ast_CAST, EXPR:t_ast_Expr).
predicate ast_Unary_op (ID:t_ast_Unary_op, OP:t_ast_OP, EXPR:t_ast_Expr).
predicate ast_Bin_op (ID:t_ast_Bin_op, LEFT:t_ast_Expr, OP:t_ast_OP, RIGHT:t_ast_Expr).
predicate ast_Conditional_expr (ID:t_ast_Conditional_expr, COND:t_ast_Expr, IFTRUE:t_ast_Expr, IFFALSE:t_ast_Expr).
predicate ast_Ignore_errors (ID:t_ast_Ignore_errors, EXPR:t_ast_Expr).
predicate ast_Constant (ID:t_ast_Constant, CLASS_NAME:maybe[t_ast_CLASS_NAME], CONSTANT_NAME:t_ast_CONSTANT_NAME).
predicate ast_Instanceof (ID:t_ast_Instanceof, EXPR:t_ast_Expr, CLASS_NAME:t_ast_Class_name).
predicate ast_Variable (ID:t_ast_Variable, TARGET:maybe[t_ast_Target], VARIABLE_NAME:t_ast_Variable_name, ARRAY_INDICES:list[maybe[t_ast_Expr]]).
predicate ast_Reflection (ID:t_ast_Reflection, EXPR:t_ast_Expr).
predicate ast_Pre_op (ID:t_ast_Pre_op, OP:t_ast_OP, VARIABLE:t_ast_Variable).
predicate ast_Post_op (ID:t_ast_Post_op, VARIABLE:t_ast_Variable, OP:t_ast_OP).
...
predicate ast_DIRECTIVE_NAME (ID:t_ast_DIRECTIVE_NAME, VALUE:string).
