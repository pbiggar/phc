...
public:
    ...
    virtual void pre_assign_target(Assign_target* in, Statement_list* out);
    ...
    virtual void pre_push_array(Push_array* in, Statement_list* out);
    ...
    virtual void pre_branch(Branch* in, Statement_list* out);
    virtual void pre_goto(Goto* in, Statement_list* out);
    virtual void pre_label(Label* in, Statement_list* out);
    virtual void pre_foreach_reset(Foreach_reset* in, Statement_list* out);
    virtual void pre_foreach_next(Foreach_next* in, Statement_list* out);
    virtual void pre_foreach_end(Foreach_end* in, Statement_list* out);
...
public:
    ...
    virtual void post_assign_target(Assign_target* in, Statement_list* out);
    ...
    virtual void post_push_array(Push_array* in, Statement_list* out);
    ...
    virtual void post_branch(Branch* in, Statement_list* out);
    virtual void post_goto(Goto* in, Statement_list* out);
    virtual void post_label(Label* in, Statement_list* out);
    virtual void post_foreach_reset(Foreach_reset* in, Statement_list* out);
    virtual void post_foreach_next(Foreach_next* in, Statement_list* out);
    virtual void post_foreach_end(Foreach_end* in, Statement_list* out);
