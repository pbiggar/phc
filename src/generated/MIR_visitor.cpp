...
void Visitor::visit_statement_list(List<Statement*>* in)
{
    ...
    {
    	pre_list("MIR", "Statement", in->size(), false);
    	...
    	post_list("MIR", "Statement", in->size(), false);
    }
}

void Visitor::visit_statement(Statement* in)
{
    visit_type("MIR", "Statement");
    if(in == NULL)
...
void Visitor::visit_interface_name_list(List<INTERFACE_NAME*>* in)
{
    ...
    {
    	pre_list("MIR", "INTERFACE_NAME", in->size(), false);
    	...
    	post_list("MIR", "INTERFACE_NAME", in->size(), false);
    }
}
...
void Visitor::visit_member_list(List<Member*>* in)
{
    ...
    {
    	pre_list("MIR", "Member", in->size(), false);
    	...
    	post_list("MIR", "Member", in->size(), false);
    }
}

void Visitor::visit_member(Member* in)
{
    visit_type("MIR", "Member");
    if(in == NULL)
...
void Visitor::visit_formal_parameter_list(List<Formal_parameter*>* in)
{
    ...
    {
    	pre_list("MIR", "Formal_parameter", in->size(), false);
    	...
    	post_list("MIR", "Formal_parameter", in->size(), false);
    }
}

void Visitor::visit_formal_parameter(Formal_parameter* in)
{
    visit_type("MIR", "Formal_parameter");
    if(in == NULL)
...
{
    visit_type("MIR", "Name_with_default");
    if(in == NULL)
...
void Visitor::visit_catch_list(List<Catch*>* in)
{
    ...
    {
    	pre_list("MIR", "Catch", in->size(), false);
    	...
    	post_list("MIR", "Catch", in->size(), false);
    }
}

void Visitor::visit_catch(Catch* in)
{
    visit_type("MIR", "Catch");
    if(in == NULL)
...
{
    visit_type("MIR", "Expr_invocation");
    if(in == NULL)
    	visit_null("MIR", "Expr_invocation");
    else
    {
...
void Visitor::visit_array_elem_list(List<Array_elem*>* in)
{
    ...
    {
    	pre_list("MIR", "Array_elem", in->size(), false);
    	...
    	post_list("MIR", "Array_elem", in->size(), false);
    }
}

void Visitor::visit_array_elem(Array_elem* in)
{
    visit_type("MIR", "Array_elem");
    if(in == NULL)
...
void Visitor::visit_actual_parameter_list(List<Actual_parameter*>* in)
{
    ...
    {
    	pre_list("MIR", "Actual_parameter", in->size(), false);
    	...
    	post_list("MIR", "Actual_parameter", in->size(), false);
    }
}

void Visitor::visit_actual_parameter(Actual_parameter* in)
{
    visit_type("MIR", "Actual_parameter");
    if(in == NULL)
