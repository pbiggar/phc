...
predicate ast_Actual_parameter (ID:t_ast_Actual_parameter, IS_REF:bool, TARGET:maybe[t_ast_Target], VARIABLE_NAME:t_ast_Variable_name, ARRAY_INDICES:list[maybe[t_ast_VARIABLE_NAME]]).
