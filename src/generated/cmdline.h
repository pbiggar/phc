...
struct gengetopt_args_info
{
  ...
  unsigned int dump_min; /**< @brief Dump input as PHP (although potentially with gotos and labels) after the pass named 'passname''s minimum occurreces */
  unsigned int dump_max; /**< @brief Dump input as PHP (although potentially with gotos and labels) after the pass named 'passname''s maximum occurreces */
  ...
  unsigned int dump_uppered_min; /**< @brief Dump input as runnable PHP after the pass named 'passname''s minimum occurreces */
  unsigned int dump_uppered_max; /**< @brief Dump input as runnable PHP after the pass named 'passname''s maximum occurreces */
  ...
  unsigned int dump_dot_min; /**< @brief Dump input as DOT after the pass named 'passname''s minimum occurreces */
  unsigned int dump_dot_max; /**< @brief Dump input as DOT after the pass named 'passname''s maximum occurreces */
  ...
  unsigned int dump_xml_min; /**< @brief Dump input as XML after the pass named 'passname''s minimum occurreces */
  unsigned int dump_xml_max; /**< @brief Dump input as XML after the pass named 'passname''s maximum occurreces */
