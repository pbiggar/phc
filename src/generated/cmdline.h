...
struct gengetopt_args_info
{
  ...
  int dump_min; /**< @brief Dump input as PHP (although potentially with gotos and labels) after PASSNAME's minimum occurreces */
  int dump_max; /**< @brief Dump input as PHP (although potentially with gotos and labels) after PASSNAME's maximum occurreces */
  ...
  int dump_xml_min; /**< @brief Dump input as XML after PASSNAME's minimum occurreces */
  int dump_xml_max; /**< @brief Dump input as XML after PASSNAME's maximum occurreces */
  ...
  int dump_dot_min; /**< @brief Dump input as DOT after PASSNAME's minimum occurreces */
  int dump_dot_max; /**< @brief Dump input as DOT after PASSNAME's maximum occurreces */
  ...
  int stats_min; /**< @brief Print statistics for the pass named 'PASSNAME's minimum occurreces */
  int stats_max; /**< @brief Print statistics for the pass named 'PASSNAME's maximum occurreces */
