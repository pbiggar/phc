...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[31] = gengetopt_args_info_full_help[50];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->define_min = -1;
  args_info->define_max = -1;
  ...
  args_info->stats_min = -1;
  args_info->stats_max = -1;
  args_info->rt_stats_help = gengetopt_args_info_full_help[46] ;
  args_info->debug_help = gengetopt_args_info_full_help[47] ;
  args_info->debug_min = -1;
  args_info->debug_max = -1;
  args_info->dont_fail_help = gengetopt_args_info_full_help[48] ;
  args_info->disable_help = gengetopt_args_info_full_help[49] ;
