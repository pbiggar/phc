...
const char *gengetopt_args_info_help[] = {
  ...
  "\nDEBUGGING PHC:",
  "      --obfuscate              Obfuscate code (TODO)  (default=off)",
    0
};
const char *gengetopt_args_info_full_help[] = {
  ...
  "      --no-run-uppering        Don't run the uppering pass (don't replace gotos \n                                 with valid, if ugly, php)  (default=off)",
  "      --obfuscate              Obfuscate code (TODO)  (default=off)",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->no_run_uppering_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->no_run_uppering_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->no_run_uppering_help = gengetopt_args_info_full_help[27] ;
  args_info->obfuscate_help = gengetopt_args_info_full_help[28] ;
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->no_run_uppering_given) {
    fprintf(outfile, "%s\n", "no-run-uppering");
  }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "no-run-uppering") == 0)
          {
            if (local_args_info.no_run_uppering_given)
              {
                fprintf (stderr, "%s: `--no-run-uppering' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->no_run_uppering_given && ! override)
              continue;
            local_args_info.no_run_uppering_given = 1;
            args_info->no_run_uppering_given = 1;
            args_info->no_run_uppering_flag = !(args_info->no_run_uppering_flag);
          }
          /* Obfuscate code (TODO).  */
