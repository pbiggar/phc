...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->dont_fail_help = gengetopt_args_info_full_help[38] ;
  args_info->no_xml_attrs_help = gengetopt_args_info_full_help[39] ;
  args_info->disable_help = gengetopt_args_info_full_help[40] ;
