...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->no_validation_help = gengetopt_args_info_full_help[13] ;
  ...
  args_info->no_hash_bang_help = gengetopt_args_info_full_help[27] ;
  args_info->no_line_numbers_help = gengetopt_args_info_full_help[29] ;
  args_info->no_nulls_help = gengetopt_args_info_full_help[30] ;
  args_info->no_empty_lists_help = gengetopt_args_info_full_help[31] ;
  args_info->debug_help = gengetopt_args_info_full_help[33] ;
  args_info->debug_min = 0;
  args_info->debug_max = 0;
  args_info->dump_help = gengetopt_args_info_full_help[34] ;
  args_info->dump_min = 0;
  args_info->dump_max = 0;
  args_info->dump_uppered_help = gengetopt_args_info_full_help[35] ;
  args_info->dump_uppered_min = 0;
  args_info->dump_uppered_max = 0;
  args_info->dump_dot_help = gengetopt_args_info_full_help[36] ;
  args_info->dump_dot_min = 0;
  args_info->dump_dot_max = 0;
  args_info->dump_xml_help = gengetopt_args_info_full_help[37] ;
