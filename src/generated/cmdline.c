...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[32] = gengetopt_args_info_full_help[54];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->debug_help = gengetopt_args_info_full_help[50] ;
  args_info->debug_min = 0;
  args_info->debug_max = 0;
  args_info->dont_fail_help = gengetopt_args_info_full_help[51] ;
  args_info->disable_help = gengetopt_args_info_full_help[52] ;
  args_info->disable_min = 0;
  args_info->disable_max = 0;
  args_info->pause_help = gengetopt_args_info_full_help[53] ;
