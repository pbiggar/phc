/*
  ...
  /bin/gengetopt --unamed-opts --input=src/generated_src/phc.ggo --file-name=src/generated/cmdline 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->no_goto_uppering_help = gengetopt_args_info_full_help[27] ;
