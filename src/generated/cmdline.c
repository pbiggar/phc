...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->no_line_numbers_help = gengetopt_args_info_full_help[23] ;
  args_info->no_nulls_help = gengetopt_args_info_full_help[24] ;
  args_info->no_empty_lists_help = gengetopt_args_info_full_help[25] ;
  args_info->tab_help = gengetopt_args_info_full_help[26] ;
  args_info->dump_help = gengetopt_args_info_full_help[28] ;
  args_info->dump_min = -1;
  args_info->dump_max = -1;
  args_info->udump_help = gengetopt_args_info_full_help[29] ;
  args_info->udump_min = -1;
  args_info->udump_max = -1;
  args_info->ddump_help = gengetopt_args_info_full_help[30] ;
  args_info->ddump_min = -1;
  args_info->ddump_max = -1;
  args_info->xdump_help = gengetopt_args_info_full_help[31] ;
  args_info->xdump_min = -1;
  args_info->xdump_max = -1;
  args_info->list_passes_help = gengetopt_args_info_full_help[32] ;
  args_info->dont_fail_help = gengetopt_args_info_full_help[33] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          {
            if (local_args_info.include_given)
              {
          ...
          {
            if (local_args_info.list_passes_given)
              {
