...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[32] = gengetopt_args_info_full_help[51];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->convert_uppered_help = gengetopt_args_info_full_help[36] ;
  args_info->no_dot_line_numbers_help = gengetopt_args_info_full_help[38] ;
  args_info->no_dot_nulls_help = gengetopt_args_info_full_help[39] ;
  args_info->no_dot_empty_lists_help = gengetopt_args_info_full_help[40] ;
  args_info->no_xml_line_numbers_help = gengetopt_args_info_full_help[42] ;
  args_info->no_xml_base_64_help = gengetopt_args_info_full_help[43] ;
  args_info->no_xml_attrs_help = gengetopt_args_info_full_help[44] ;
  args_info->stats_help = gengetopt_args_info_full_help[46] ;
  args_info->stats_min = 0;
  args_info->stats_max = 0;
  args_info->rt_stats_help = gengetopt_args_info_full_help[47] ;
  ...
  args_info->disable_help = gengetopt_args_info_full_help[50] ;
