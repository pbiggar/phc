...
const char *gengetopt_args_info_full_help[] = {
  ...
  "      --sdump=passname     Dump input into Saturn databases after the pass \n                             named 'passname'",
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->sdump_given, &(args_info->sdump_arg), &(args_info->sdump_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->sdump_given, "sdump", args_info->sdump_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->sdump_given, args_info->sdump_min, args_info->sdump_max, "'--sdump'"))
     error = 1;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Dump input into Saturn databases after the pass named 'passname'.  */
          else if (strcmp (long_options[option_index].name, "sdump") == 0)
          {
