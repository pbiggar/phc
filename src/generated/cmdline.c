  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'c':	/* Compile.  */
          if (local_args_info.compile_given || (check_ambiguity && args_info->compile_given))
            {
        ...
        case 'O':	/* Optimize.  */
          if (local_args_info.optimize_given || (check_ambiguity && args_info->optimize_given))
            {
        ...
        case 0:	/* Long option with no short option */
          ...
          {
            if (local_args_info.pretty_print_given || (check_ambiguity && args_info->pretty_print_given))
              {
          ...
          {
            if (local_args_info.obfuscate_given || (check_ambiguity && args_info->obfuscate_given))
              {
          ...
          {
            if (local_args_info.read_ast_xml_given || (check_ambiguity && args_info->read_ast_xml_given))
              {
          ...
          {
            if (local_args_info.no_validation_given || (check_ambiguity && args_info->no_validation_given))
              {
          ...
          {
            if (local_args_info.include_given || (check_ambiguity && args_info->include_given))
              {
                fprintf (stderr, "%s: `--include' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->include_given && ! override)
              continue;
            local_args_info.include_given = 1;
            args_info->include_given = 1;
            args_info->include_flag = !(args_info->include_flag);
          }
          /* Generate C code.  */
          else if (strcmp (long_options[option_index].name, "generate-c") == 0)
          {
            if (local_args_info.generate_c_given || (check_ambiguity && args_info->generate_c_given))
              {
          ...
          {
            if (local_args_info.extension_given || (check_ambiguity && args_info->extension_given))
              {
          ...
          {
            if (local_args_info.with_php_given || (check_ambiguity && args_info->with_php_given))
              {
          ...
          {
            if (local_args_info.next_line_curlies_given || (check_ambiguity && args_info->next_line_curlies_given))
              {
          ...
          {
            if (local_args_info.no_leading_tab_given || (check_ambiguity && args_info->no_leading_tab_given))
              {
                fprintf (stderr, "%s: `--no-leading-tab' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->no_leading_tab_given && ! override)
              continue;
            local_args_info.no_leading_tab_given = 1;
            args_info->no_leading_tab_given = 1;
            args_info->no_leading_tab_flag = !(args_info->no_leading_tab_flag);
          }
          /* Don't show line numbers when dumping DOT/XML.  */
          else if (strcmp (long_options[option_index].name, "no-line-numbers") == 0)
          {
            if (local_args_info.no_line_numbers_given || (check_ambiguity && args_info->no_line_numbers_given))
              {
          ...
          {
            if (local_args_info.no_nulls_given || (check_ambiguity && args_info->no_nulls_given))
              {
          ...
          {
            if (local_args_info.no_empty_lists_given || (check_ambiguity && args_info->no_empty_lists_given))
              {
          ...
          {
            if (local_args_info.list_passes_given || (check_ambiguity && args_info->list_passes_given))
              {
                fprintf (stderr, "%s: `--list-passes' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->list_passes_given && ! override)
              continue;
            local_args_info.list_passes_given = 1;
            args_info->list_passes_given = 1;
            args_info->list_passes_flag = !(args_info->list_passes_flag);
          }
          /* Dont fail on error (after parsing).  */
          else if (strcmp (long_options[option_index].name, "dont-fail") == 0)
          {
            if (local_args_info.dont_fail_given || (check_ambiguity && args_info->dont_fail_given))
              {
