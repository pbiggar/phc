...
$query = "SELECT RatingTotal, RatedTotal from articles WHERE FileID=$a";
...
// pop the values back into the database
   ...
   $query = "UPDATE articles SET RatingTotal = '$newratingtotal', RatedTotal = '$newratedtotal' WHERE FileID='$a'";
   $result = mysql_query($query);
   if (mysql_errno()) {
