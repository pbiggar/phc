...
void twiddle1(void *v) {
  struct str *s = (struct str*)(((long)v) & ~0x1);
  int y = s->a;
}

void twiddle2(void *v) {
  struct str *s = (struct str*)((((long)v) + 0x1f) & ~0x1f);
  int y = s->a;
}
...
int get_offset()
{
  return __builtin_offsetof(struct kiocb,ki_list);
}
